<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="公告标题" prop="gonggaobiaoti">
					<el-input v-model="ruleForm.gonggaobiaoti" placeholder="公告标题" clearable  :readonly="ro.gonggaobiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="公告标题" prop="gonggaobiaoti">
					<el-input v-model="ruleForm.gonggaobiaoti" placeholder="公告标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="公告类型" prop="gonggaoleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="公告类型" prop="gonggaoleixing">
					<el-input v-model="ruleForm.gonggaoleixing"
						placeholder="公告类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.gonggaotupian" label="公告图片" prop="gonggaotupian">
					<file-upload
						tip="点击上传公告图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.gonggaotupian" label="公告图片" prop="gonggaotupian">
					<img class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gonggaotupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"rgba(0, 0, 0, 1)","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gonggaoneirong"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../springboot91u00/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

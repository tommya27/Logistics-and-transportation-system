	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="联系地址" prop="lianxidizhi">
					<el-input v-model="ruleForm.lianxidizhi" placeholder="联系地址" clearable  :readonly="ro.lianxidizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="联系地址" prop="lianxidizhi">
					<el-input v-model="ruleForm.lianxidizhi" placeholder="联系地址" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="寄件单价" prop="jijiandanjia">
					<el-input v-model="ruleForm.jijiandanjia" placeholder="寄件单价" clearable  :readonly="ro.jijiandanjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="寄件单价" prop="jijiandanjia">
					<el-input v-model="ruleForm.jijiandanjia" placeholder="寄件单价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="收费说明" prop="shoufeishuoming">
					<el-input v-model="ruleForm.shoufeishuoming" placeholder="收费说明" clearable  :readonly="ro.shoufeishuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="收费说明" prop="shoufeishuoming">
					<el-input v-model="ruleForm.shoufeishuoming" placeholder="收费说明" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="网点信息" prop="wangdianxinxi">
					<el-input v-model="ruleForm.wangdianxinxi" placeholder="网点信息" clearable  :readonly="ro.wangdianxinxi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="网点信息" prop="wangdianxinxi">
					<el-input v-model="ruleForm.wangdianxinxi" placeholder="网点信息" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jijiandanjia'){
							this.ruleForm.jijiandanjia = obj[o];
							this.ro.jijiandanjia = true;
							continue;
						}
						...
						if(o=='wangdianxinxi'){
							this.ruleForm.wangdianxinxi = obj[o];
							this.ro.wangdianxinxi = true;
							continue;
						}
				}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wuliugongsi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wuliugongsiCrossAddOrUpdateFlag = false;
						 this.parent.search();

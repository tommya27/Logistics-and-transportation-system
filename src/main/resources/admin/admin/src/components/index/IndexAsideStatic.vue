<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"40px 0","listStyle":"none","margin":"70px 0 0 0","background":"#FFF","position":"relative","height":"calc(100vh - 70px)"}' class="el-menu-vertical-demo" default-active="0">

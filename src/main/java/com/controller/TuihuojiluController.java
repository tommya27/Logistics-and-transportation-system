...
public class TuihuojiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,TuihuojiluEntity tuihuojilu,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date tuihuoshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date tuihuoshijianend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			tuihuojilu.setYonghuming((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("wuliugongsi")) {
			tuihuojilu.setWuliugongsi((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<TuihuojiluEntity> ew = new EntityWrapper<TuihuojiluEntity>();
                if(tuihuoshijianstart!=null) ew.ge("tuihuoshijian", tuihuoshijianstart);
                if(tuihuoshijianend!=null) ew.le("tuihuoshijian", tuihuoshijianend);

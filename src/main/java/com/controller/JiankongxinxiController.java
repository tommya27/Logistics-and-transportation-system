...
public class JiankongxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiankongxinxiEntity jiankongxinxi,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date jiankongshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date jiankongshijianend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("wuliugongsi")) {
			jiankongxinxi.setWuliugongsi((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<JiankongxinxiEntity> ew = new EntityWrapper<JiankongxinxiEntity>();
                if(jiankongshijianstart!=null) ew.ge("jiankongshijian", jiankongshijianstart);
                if(jiankongshijianend!=null) ew.le("jiankongshijian", jiankongshijianend);

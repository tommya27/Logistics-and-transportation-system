...
public class PingjiajiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,PingjiajiluEntity pingjiajilu,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date pingjiariqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date pingjiariqiend,
		...
		if(tableName.equals("wuliugongsi")) {
			pingjiajilu.setWuliugongsi((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<PingjiajiluEntity> ew = new EntityWrapper<PingjiajiluEntity>();
                if(pingjiariqistart!=null) ew.ge("pingjiariqi", pingjiariqistart);
                if(pingjiariqiend!=null) ew.le("pingjiariqi", pingjiariqiend);

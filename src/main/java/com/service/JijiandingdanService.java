...
public interface JijiandingdanService extends IService<JijiandingdanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JijiandingdanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JijiandingdanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JijiandingdanEntity> wrapper);
}
